...
public class BoardController {
	...
	@ResponseBody
	@RequestMapping(value = "/board/priority", method = RequestMethod.PUT)
	public Map<String,Object> updatePriority(@RequestParam int no, @RequestParam int priority, HttpSession session) {
	
		BoardDTO boardDTO = new BoardDTO();
		boardDTO.setPriority(priority);
		boardDTO.setNo(no);
		try {
			boardService.updatePriority(boardDTO);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
